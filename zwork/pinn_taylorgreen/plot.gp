# plot.gp -- pinn_taylorgreen.  Run `gnuplot plot.gp` after a run; writes plot.png.
#
...
#   output_set0002.dat  9:  x(1:3)  prediction(1:3)  exact(1:3)
...
#
# The inputs are 3-dimensional, so a field cannot be drawn as a
# plane: the honest picture is the parity plot, network against
# exact, where a perfect fit is the diagonal.

set terminal pngcairo size 2800,560 font ",11"
set output "plot.png"
...
set size ratio 1
set xlabel "exact"; set ylabel "network"
set title "parity, component 1 of 3"
plot x with lines lc rgb "gray" lw 1 notitle, \
     out u 7:4 with points pt 7 ps 0.5 notitle
...
set size ratio 1
set xlabel "exact"; set ylabel "network"
set title "parity, component 2 of 3"
plot x with lines lc rgb "gray" lw 1 notitle, \
     out u 8:5 with points pt 7 ps 0.5 notitle
unset xrange; unset yrange

stats out u 9 nooutput
lo = STATS_min; hi = STATS_max
set xrange [lo:hi]; set yrange [lo:hi]
set size ratio 1
set xlabel "exact"; set ylabel "network"
set title "parity, component 3 of 3"
plot x with lines lc rgb "gray" lw 1 notitle, \
     out u 9:6 with points pt 7 ps 0.5 notitle
unset xrange; unset yrange
