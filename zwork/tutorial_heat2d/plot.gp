# plot.gp -- tutorial_heat2d.  Run `gnuplot plot.gp` after a run; writes plot.png.
#
...
#   output_set0002.dat  5:  x(1:3)  prediction(1:1)  exact(1:1)
...
plot x with lines lc rgb "gray" lw 1 notitle, \
     out u 5:4 with points pt 7 ps 0.5 notitle
