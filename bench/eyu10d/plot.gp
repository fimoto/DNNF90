# plot.gp -- eyu10d.  Run `gnuplot plot.gp` after a run; writes plot.png.
#
...
#   output_set0002.dat  12:  x(1:10)  prediction(1:1)  exact(1:1)
...
#
# The inputs are 10-dimensional, so a field cannot be drawn as a
...
plot x with lines lc rgb "gray" lw 1 notitle, \
     out u 12:11 with points pt 7 ps 0.5 notitle
